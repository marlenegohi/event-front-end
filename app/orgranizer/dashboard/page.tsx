    ...
    return (
        <div className="flex min-h-screen bg-gray-50 dark:bg-neutral-950">
            ...
            <main className="ml-64 flex-1 p-6 space-y-6">
                <div className="mb-5">
                    <h1 className="text-xl font-medium text-gray-800 dark:text-white">Dashboard</h1>
                    <p className="text-sm text-gray-400">Bienvenue, John — voici vos stats du mois</p>
                </div>
                ...
                <div className="bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800 rounded-2xl p-4">
                    <h2 className="text-sm font-medium text-gray-800 dark:text-white mb-4">Concerts récents</h2>
                        ...
                        {concerts.map((c) => (
                            <div key={c.id} className="flex items-center gap-3 py-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-xs text-gray-400">{c.date} · {c.venue}</div>
                                </div>
                                <div className="text-xs text-gray-400 mr-2">{c.sold}/{c.total}</div>
